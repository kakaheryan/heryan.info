  ...
  return (
    <footer className="pb-2 mt-4 b-0 ">
      <main className="flex flex-col items-center pt-6 border-t border-gray-400 dark:border-gray-600 layout">
        <FooterLinks />
        <p className="mt-12 text-gray-500 dark:text-gray-300">Reach me out</p>
        ...
        <p className="mt-6 font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-green-300 to-yellow-300">
  ...
  return (
    <div className="flex flex-wrap justify-center space-x-3">
      {footerLinks.map(({ href, text }) => (
        <a
          key={text}
          className="rounded-sm dark:text-gray-200focus:outline-none focus-visible:ring focus-visible:ring-primary-300"
          href={href}
        >
          {text}
        </a>
